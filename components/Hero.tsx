...
export default function Hero() {
 return <section id="home" className="hero container">
   ...
   <figure className="portrait"><Image src="/image/profile.webp" alt="Saroj Bhandari" width={340} height={390} sizes="(max-width: 640px) 190px, 290px" preload/><figcaption className="portrait-description">
     <span>Researcher in NLP, LLMs &amp; Retrieval-Augmented Generation</span>
     <span>Founder &amp; CEO @ Kritim Mind Technology</span>
     <span>TU Topper B.Sc. CSIT (92.4% Final Sem / 85.57% Overall)</span>
     <span>Software Developer &amp; AI/ML Engineer</span>
   </figcaption></figure>
 </section>;
}
